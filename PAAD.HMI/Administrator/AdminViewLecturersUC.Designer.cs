namespace PAAD.HMI.Administrator
{
	partial class AdminViewLecturersUC
	{
		...
		private void InitializeComponent()
		{
			...
			dataGridView_Lecturer.Location = new Point(50, 209);
			dataGridView_Lecturer.Margin = new Padding(4);
			...
			dataGridView_Lecturer.Size = new Size(1289, 524);
			...
			btnAddLecturer.Location = new Point(621, 758);
			btnAddLecturer.Margin = new Padding(2);
			btnAddLecturer.Name = "btnAddLecturer";
			btnAddLecturer.Size = new Size(149, 62);
			...
			// btnBack
			// 
			btnBack.Location = new Point(20, 134);
